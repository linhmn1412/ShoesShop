...
<footer class=" container text-center text-lg-start bg-light text-muted">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p>
                    ...
                    <p><i class="fas fa-home me-3"></i> Ho Chi Minh, Viet Nam</p>
        </div>
      </div>
  ...
  <section class=" justify-content-center justify-content-lg-between p-4 border-top">
        <div class="text-center me-5 d-none d-lg-block">
            <span class="text-center" style="color: #185137;">© 2023<a style="color: #185137;" href="/">&ensp;<b>Shoes Shop</b>&ensp;</a>All Rights Reserved.
            </span>
        </div>
    </section>
